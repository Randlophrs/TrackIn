    ...
    (() => {
            ...
            constructor(t, e, i) {
                if (
                    ...
                    if (void 0 === t || void 0 === e)
                        throw new Error(
                            `${f} Vector3d not initialized correctly`
                        );
        ...
        class zt {
            ...
            static create(t, e) {
                ...
                return (
                    i.load(t),
                    void 0 !== e &&
                        (bt(e) || kt(e) ? i.load({ value: e }) : i.load(e)),
                    i
                );
            }
            load(t) {
            ...
            load(t) {
                void 0 !== t &&
                    ...
                    void 0 !== t.position &&
                        ((this.position = {}),
                        void 0 !== t.position.x &&
                            (this.position.x = O(t.position.x)),
                        void 0 !== t.position.y &&
                            (this.position.y = O(t.position.y))),
        ...
        class oe {
            constructor(t, e, i, s) {
                (this.absorbers = t),
                    ...
                    (this.size =
                        P(this.options.size.value) * e.retina.pixelRatio),
                    (this.mass =
                        this.size *
                ...
                (this.limit = {
                    radius:
                        o.radius * e.retina.pixelRatio * e.retina.reduceFactor,
                    mass: o.mass,
                }),
                    (this.color = Vt(this.options.color) ?? {
                        b: 0,
                        g: 0,
                        r: 0,
                    }),
            ...
            load(t) {
                ...
                if (
                    ...
                    for (const e in t.groups) {
                        const i = t.groups[e];
                        void 0 !== i &&
                            (this.groups[e] = st(this.groups[e] ?? {}, i));
                    }
                ...
                if (
                    ...
                    const e = this._engine.plugins.updaters.get(
                        this._container
                    );
                    if (e)
                        for (const i of e)
                            i.loadOptions && i.loadOptions(this, t);
                    const i = this._engine.plugins.interactors.get(
                        this._container
                    );
                    if (i)
                        for (const e of i)
                            e.loadParticlesOptions &&
                                e.loadParticlesOptions(this, t);
                }
            }
        }
        function Ne(t, ...e) {
        ...
        function Ye(t, e, i, s) {
            ...
            return e.particles.addParticle(
                ...
                (t) =>
                    !(t.size.value < 0.5) &&
                    ((t.velocity.length = M(
                        O(i.velocity.length, t.velocity.length)
                    )),
                ...
                (this.emitters = e),
                    ...
                    (this._emitParticles = (t) => {
                        ...
                        for (let o = 0; o < t; o++) {
                            ...
                            if (!e) return;
                            const o =
                                this._shape?.randomPosition(e, i, this.fill) ??
                                e;
                    ...
                    (this._setColorAnimation = (t, e, i) => {
                        ...
                        const o = M(t.offset),
                            n =
                                (1e3 * P(this.options.rate.delay)) /
                                s.retina.reduceFactor;
                        return (
                            (e + (P(t.speed ?? 0) * s.fpsLimit) / n + 3.6 * o) %
                            i
                        );
                    }),
                    (this._engine = t),
                    ...
                    (this._spawnDelay =
                        ...
                        this.container.retina.reduceFactor),
                    (this.position =
                        this._initialPosition ?? this._calcPosition()),
                    (this.name = this.options.name),
        ...
        class di extends li {
            ...
            async interact(t) {
                ...
                if (
                    (this._delay < o && (this._delay += t.value),
                    this._delay < o)
                )
                    return;
                const n = !(
                ...
                (this.container = t),
                    ...
                    (this._applyPreDrawUpdaters = (t, e, i, s, o, n) => {
                        for (const a of this._preDrawUpdaters) {
                            if (a.getColorStyles) {
                                const { fill: n, stroke: r } = a.getColorStyles(
                                    e,
                                    t,
                                    i,
                                    s
                    ...
                    (this._initCover = () => {
                        const t =
                                this.container.actualOptions.backgroundMask
                                    .cover,
                            e = Vt(t.color);
                        if (e) {
                ...
                (this.container = t),
                    ...
                    (this._manageListeners = (t) => {
                        ...
                        "window" === s
                            ...
                            document &&
                                Si(document, p, e.visibilityChange, t, !1);
                    }),
                    (this._manageMediaMatch = (t) => {
                        const e = this._handlers,
                    ...
                    (this._mouseTouchMove = (t) => {
                        ...
                        if (
                            ...
                            ((this._canPush = "touchmove" !== t.type), o)
                        ) {
                            const e = t,
        ...
        class ji {
            ...
            load(t) {
                if (!t) return;
                void 0 !== t.preset &&
                    dt(t.preset, (t) => this._importPreset(t)),
                    void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
                    void 0 !== t.delay && (this.delay = O(t.delay));
                ...
                (this.defaultThemes.dark =
                    this._findDefaultTheme("dark")?.name),
        ...
        class Yi {
                ...
                (this.container = i),
                    ...
                    (this._getRollColor = (t) => {
                        if (
                            !t ||
                            !this.roll ||
                            (!this.backColor && !this.roll.alter)
                        )
                            return t;
                        const e =
                                this.roll.horizontal && this.roll.vertical
                                    ? 2
                                    : 1,
                    ...
                    (this._initPosition = (t) => {
                        ...
                        switch (
                            ((this.moveCenter = {
                                ...
                                mode:
                                    this.options.move.center.mode ?? "percent",
                            }),
                            (this.direction = E(
            ...
            getStrokeColor() {
                return this._getRollColor(
                    this.bubble.color ?? ee(this.strokeColor)
                );
            }
            init(t, e, i, s) {
                const o = this.container,
                ...
                (this.pathDelay = 1e3 * T(f.delay)),
                    f.generator &&
                        ((this.pathGenerator =
                            this._engine.plugins.getPathGenerator(f.generator)),
                        this.pathGenerator &&
        ...
        class Qi extends Zi {
            ...
            contains(t) {
                const e = this.size.width,
                    ...
                    s = this.position;
                return (
                    t.x >= s.x && t.x <= s.x + e && t.y >= s.y && t.y <= s.y + i
                );
            }
            intersects(t) {
        ...
        class is {
            constructor(t, e) {
                (this._applyDensity = (t, e, i) => {
                    ...
                    (this._initDensityFactor = (t) => {
                        ...
                        return (
                            (i.width * i.height) / (t.factor * s ** 2 * t.area)
                        );
                    }),
            ...
            async update(t) {
                ...
                for (const e of this._array) {
                    ...
                    e.destroyed ||
                        e.spawning ||
                        (await this._interactionManager.particlesInteract(
                            e,
                            t
                        ));
                }
        ...
        class ss {
            ...
            initParticle(t) {
                ...
                (a.horizontal =
                    ...
                    (a.vertical =
                        void 0 !== o.vertical ? o.vertical * i : void 0),
        ...
        class rs {
            constructor(t, e, i) {
                (this.id = e),
                    (this._intersectionManager = (t) => {
                        if (
                            os(this) &&
                            this.actualOptions.pauseOnOutsideViewport
                        )
                            for (const e of t)
            ...
            setPath(t, e, i) {
                ...
                const s = { ...as };
                if (xt(t))
                    (s.generate = t), e && (s.init = e), i && (s.update = i);
                else {
                    const e = s;
        ...
        function ls(t, e, i, s = !1) {
            ...
            return (
                (o && !s) ||
                    ((o = [...i.values()].map((e) => e(t))), e.set(t, o)),
                o
            );
        }
        class hs {
        ...
        class ds {
            ...
            async addShape(t, e, i, s, o, n = !0) {
                ...
                gt(i) ? ((h = i), (r = void 0)) : (r = i),
                    ...
                    (a = xt(e)
                        ? { afterEffect: c, destroy: l, draw: e, init: r }
                        : e),
        ...
        function gs(t, e, i, s, o, n) {
            ...
            o && i && (t.velocity.x += (o * n.factor) / (60 * i)),
                a?.enable &&
                    i &&
                    (t.velocity.y +=
                        (r * (a.acceleration * n.factor)) / (60 * i));
            const c = t.moveDecay;
            t.velocity.multTo(c);
            ...
            move(t, e) {
                ...
                s.spin.enable
                    ? (function (t, e) {
                          ...
                          (t.position.x =
                              t.spin.center.x +
                              t.spin.radius * s.x(t.spin.angle)),
                              (t.position.y =
                                  t.spin.center.y +
                                  t.spin.radius * s.y(t.spin.angle)),
                        ...
                        if (r || c)
                            if (
                                ...
                                (t.misplaced =
                                    ...
                                    r &&
                                        (t.velocity.x =
                                            t.velocity.y / 2 - t.velocity.x),
                                    c &&
                                        (t.velocity.y =
                                            t.velocity.x / 2 - t.velocity.y);
                            else if (
                                (!r || o < r) &&
                                (!c || n < c) &&
                                t.misplaced
        ...
        class zs {
            ...
            update(t, e, i, s) {
                ...
                for (const [, s] of o.plugins)
                    if (
                        (void 0 !== s.particleBounce &&
                            (n = s.particleBounce(t, i, e)),
                        n)
                    )
                        break;
                if (n) return;
            ...
            constructor(t, e) {
                super(e),
                    ...
                    (this.handleClickMode = (t) => {
                        const i =
                            this.container.actualOptions.interactivity.modes
                                .attract;
                        if (i && "attract" === t) {
                            e.attract || (e.attract = { particles: [] }),
            ...
            constructor(t) {
                super(t),
                    (this._processBounce = (t, e, i) => {
                        const s = this.container.particles.quadTree.query(
                            i,
                            (t) => this.isEnabled(t)
                        );
                        for (const o of s)
                    ...
                    (this._clickBubble = () => {
                        ...
                        for (const e of n) {
                            ...
                            const n = D(e.getPosition(), i),
                                r =
                                    (new Date().getTime() -
                                        (t.interactivity.mouse.clickTime ||
                                            0)) /
                                    1e3;
                        ...
                        n &&
                            ...
                            o.forEach((e) => {
                                const o = e,
                                    ...
                                    h = s.particles.quadTree.query(l, (t) =>
                                        this.isEnabled(t)
                                    );
                                for (const e of h) {
            ...
            init() {
                ...
                e &&
                    ((t.retina.bubbleModeDistance =
                        e.distance * t.retina.pixelRatio),
                    void 0 !== e.size &&
                        (t.retina.bubbleModeSize =
                            e.size * t.retina.pixelRatio));
            }
            async interact(t) {
            ...
            constructor(t, e) {
                super(e),
                    (this._clickRepulse = () => {
                        ...
                        if (
                            ...
                            const a = new Ki(n.x, n.y, o),
                                r = t.particles.quadTree.query(a, (t) =>
                                    this.isEnabled(t)
                                );
                            for (const t of r) {
                                const {
                    ...
                    (this._processRepulse = (t, e, i, s) => {
                        const o = this.container,
                            n = o.particles.quadTree.query(i, (t) =>
                                this.isEnabled(t)
                            ),
                    ...
                    await (async function (t, e, i, s, o, n) {
                        ...
                        const d = (t) => {
                                const {
                                    ...
                                    c ? a.localColorTable : e.globalColorTable
                                )[t];
                                return {
                                    r: s,
                                    g: n,
                        ...
                        (t.gifLoopCount =
                            (function (t) {
                                for (const e of t.applicationExtensions)
                                    if (
                                        e.identifier + e.authenticationCode ===
                                        "NETSCAPE2.0"
                                    )
            ...
            draw(t, e, i, s, o) {
                ...
                if (n) {
                    if (((t.globalAlpha = s), n.gif && n.gifData)) {
                        ...
                        if (
                            (void 0 === e.gifTime && (e.gifTime = 0), !l.bitmap)
                        )
                            return;
                        switch (
                            ...
                            case 2:
                                a.drawImage(l.bitmap, l.left, l.top),
                                    ...
                                    0 === n.gifData.globalColorTable.length
                                        ...
                                        : a.putImageData(
                                              n.gifData.backgroundImage,
                                              c.x,
                                              c.y
                                          );
                                break;
                            case 3: {
                                const e = a.getImageData(
                                    0,
                                    0,
                                    s.width,
                                    s.height
                        ...
                        if (((e.gifTime += o.value), e.gifTime > l.delayTime)) {
                            if (
                                ((e.gifTime -= l.delayTime),
                                ++r >= n.gifData.frames.length)
                            ) {
        ...
        class go {
            ...
            load(t) {
                t &&
                    ...
                    void 0 !== t.height && (this.height = t.height),
                    void 0 !== t.name && (this.name = t.name),
                    void 0 !== t.replaceColor &&
                        (this.replaceColor = t.replaceColor),
            ...
            async interact(t, e) {
                ...
                for (const a of n) {
                    if (
                        ...
                        t.options.collisions.mode !==
                            a.options.collisions.mode ||
                        a.destroyed ||
                        a.spawning
                    )
                        continue;
                    const n = a.getPosition(),
                        r = a.getRadius();
                    if (Math.abs(Math.round(s.z) - Math.round(n.z)) > o + r)
                        continue;
        ...
        class Bo extends fs {
            ...
            async interact(t) {
                ...
                for (const i of l) {
                    ...
                    if (l.x < 0 || l.y < 0 || l.x > s.width || l.y > s.height)
                        continue;
                    const h = Fo(e, l, a, s, r && c.warp);
                    if (h > a) continue;
                    const d = (1 - h / a) * n;
                    this._setColor(t),
                        t.links.push({ destination: i, opacity: d });
                }
            }
            isEnabled(t) {
        ...
        class Vo {
            ...
            drawParticle(t, e) {
                ...
                const o = i.filter(
                    (t) =>
                        s.links &&
                        this._getLinkFrequency(e, t.destination) <=
                            s.links.frequency
                );
                for (const t of o)
        ...
        class hn {
            getColorStyles(t, e, i, s) {
                ...
                const n = o.particles,
                    ...
                    p = a && d;
                return (
                    (u.fill = p ? d : void 0), (u.stroke = p ? d : void 0), u
                );
            }
            init() {}
            isEnabled(t) {
        ...
        class pn {
            ...
            isEnabled(t) {
                return (
                    !t.destroyed && !t.spawning && !!t.options.wobble?.enable
                );
            }
            loadOptions(t, ...e) {
            ...
            await (async function (t, e = !0) {
                ...
                await (async function (t, e = !0) {
                    t.emitterShapeManager ||
                        (t.emitterShapeManager = new ni(t)),
                        t.addEmitterShape ||
