...
@section('content')
    <div class="container mx-auto px-4">
        ...
        <div class="fixed bottom-0 right-0 px-8 py-2 m-6 rounded-md w-1/8">
            ...
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit"
                    class="text-xl w-full bg-[#C32F27] text-[#FDFFFC] py-2 rounded-md font-semibold mt-5 transition duration-300 ease-in-out cursor-pointer">Keluar</button>
            </form>
        </div>

        {{-- <a href="{{route('logout')}}"
            class="bg-[#C32F27] text-[#FDFFFC] text-2xl fixed bottom-0 right-0 px-8 py-2 m-6 rounded-md">
